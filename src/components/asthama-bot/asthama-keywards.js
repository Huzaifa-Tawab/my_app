...
class UtiKeywards {
  ...
  parse(message) {
    ...
    const key1 =["my name", "doctor", "physician", "associate", "pharmacist"];
    const key2 =["born", "dob", "birth", "your name", "date"];
    const advice =["advice"];
    const name =["name"];
    const key3 = ["old", "age"];
    const key4 = ["consent","history", "is that okay", "is that alright", "are you okay with"];
    const key5 = ["alright", "how are you", "how do you", "feeling"];
    const key6 = [ "syncope", "help", "been happening", "here for","concerned", "short of breath", "breathe"];
    ...
    const key9 = ["coughing", "phlegm", "sputum", "mucus", "cough", "dry cough", "bringing anything up"];
    ...
    const key13 = ["relieves", "improves", "alleviates", "eases", "better"];
    const key14 = ["harsher", "worse", "exacerbates", "aggravates", "triggers", "progressive", "gradual"];
    const key15 = ["signs", "other symptoms", "vomiting", "nausea", "abdominal pain"];
    const key16 = [ "score", "out of 10", "how severe", "severity"];
    const key17 = ["previous", "prior", "preceding", "earlier", "before", "episodes", "similar", "aura"];
    const key18 = ["throughout", "during"];
    const key19 = ["following", "after"];
    const key20 = ["underlying conditions", "known conditions", "diagnosed", "medical history", "recently unwell", "cold", "strep", "obesity", "surgery", "surgeries", "diabetes", "admission", "hospital"];
    const key21 = ["immunised", "vaccines"];
    const key22 = ["drugs", "recreational", "over the counter", "analgesia", "pain relief", "nsaid", "medications", "meds", "ointment", "cream"];
    ...
    const key30 = ["routine", "daily life", "way of life", "walk", "exercise", "fitness", "workout", "lifestyle"];
    const key31 = ["coffee",  "caffeine" ];
    const key32 = ["breath", "short of", "breathing", "sob", "shortness", "wheezing", "wheeze"];
    const key33 = [ "feverish", "fever", "shivering", "rigors", "sweating", "sweat"];
    ...
    const key38 = ["upset", "down", "sad", "unhappy", "miserable", "stress", "stressed"];
    const key39 = ["anxious", "anxiety"];
    const key40 = ["mood", "behaviour", "attitude"];
    const key41 = ["adjustments", "new", "recent changes","life changes"];
    const key42 = ["damage", "wound", "hard", "accident", "trauma", "injury "];
    const key43 = ["hay fever", "asthma", "eczema"];
    const key44 = ["urinate", "wee", "poo", "faeces", "diarrhoea", "diarrhoeal", "incontinent", "incontinence", "urine", "bowel", "toilet", "constipated", "constipation", "water works", "toileting", "dysuria", "stool", "colour"];
    const key45 = ["lesions", "pimples", "spots", "hives", "rash", "rashes", "skin", "irritation"];
    const key46 = ["hear", "smelling", "sight", "vision", "sounds", "sound", "listen", "visual", "hear", "hearing", "smell", "smelling", "dizzy", "dizziness"];
    ...
    const key51 = ["faint","blackout", "collapse","consciousness"];
    const key52 = ["think", "thoughts", "your ideas"];
    const key53 = ["worrying", "troubling you", "concerns"];
    const key54 = ["expect", "out of", "you want to", "expectations"];
    const key55 = ["holidays", "journey", "flight", "long haul", "travel", "exotic", "countries"];
    const key56 = ["anything else"];
    const key57 = ["anal tone", "anal sensation"];
