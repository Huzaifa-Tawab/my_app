...
class MessageParser {
  ...
  parse(message) {
    ...
    const helloo=["my name", "doctor", "physician", "associate", "pharmacist","hey","hello","my name","hey"]
      const age = ["age", "old"];
      const newW=["how long", "going on for"];
      const dob=["born","dob", "birth", "your name", "date"];
      const conset=[ "Consent","take a history","some question","some questions", "is that okay","is that ok", "is that alright", "are you okay with","history from you"];
      ...
      const r37=['damage', "wound", "hard", "accident", "trauma"," injury "]
      const r38=["hay fever", "asthma", "eczema"]
