       ...
       <div className='scenariobody'>
        ...
        <div class="scene">
            <div class="scene_img">
                <img src={img15} alt=""/>
                <br/>
                <span>Julia Winter</span>
            </div>
            <Link to="/migraineChatroom" class="scene_text">
                <p>You are a clinician working in the community. Julia Winter a 22-year-old lady has come in today due to experiencing a severe persistent headache. The patient appears stable but very unwell in herself.</p>                </Link>
        </div>
        {/* 2 */}
        {/* <div class="scene">
            <div class="scene_img">
